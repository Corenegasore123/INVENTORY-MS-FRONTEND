...
import { BarChart3, BoxIcon, Home, LogOut, Menu, Package, Settings, User, X } from "lucide-react"
...
export default function DashboardLayout({
  ...
  const navigation = [
    ...
    { name: "Inventories", href: "/dashboard/inventories", icon: Package },
                  ...
                  >
                    <item.icon
                      className={`mr-4 h-6 w-6 flex-shrink-0 ${
                        isItemActive ? "text-indigo-600" : "text-gray-400 group-hover:text-gray-500"
                      }`}
                    />
                    {item.name}
                  </Link>
